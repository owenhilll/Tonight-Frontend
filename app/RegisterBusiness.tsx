        ...
        <Modal visible={showModal} transparent={true}>
          <View
            ...
            <View
              ...
              <Text className="mb-2 text-center text-2xl text-white underline">
                What to expect:{' '}
              </Text>
              ...
              <Text className="flex-1 text-center text-lg text-white">
                We encourage you to create a standard User account while you await confirmation.
                This will provide you with insights into how to market your events to your local
                populus!
              </Text>
              <TouchableOpacity
